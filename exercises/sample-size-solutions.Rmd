...
# Load data set
load(file="data/clinical-dataset.RData")
...
![Power analysis VAR(1)](images/exercice-var-estimate.png)
...
![Sensitivity analysis for power](images/sensitive-pow1.jpg)
...
![Sensitivity analysis for power](images/ci-sensitive-pow.jpg)
...
![PAA for VAR(1)](images/paa-exercice-curve.png)
...
![Sensitive PAA for VAR(1)](images/paa-sensitive.png)
